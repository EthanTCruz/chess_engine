...
class metaDataBoardEval:
    def __init__(self,game: GamePositions):
        self.endgameAmount = Settings().minimumEndgamePieces
    ...
    def get_board_scores(self):
        ...
        # print("get_piece_amounts:", time.time() - start)
        ...
        dict_results["Beginning Game"] = game_time[0]
        dict_results["Middle Game"] = game_time[1]
        dict_results["End Game"] = game_time[2]
        ...
        # print("can_be_drawn:", time.time() - start)
        ...
        # print("is_queen_in_danger:", time.time() - start)
        ...
        # print("attacks_per_side:", time.time() - start)
